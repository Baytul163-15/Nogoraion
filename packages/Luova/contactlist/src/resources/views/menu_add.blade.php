        ...
        <div class="col-md-7">
            <div class="panel panel-bordered">
                ...
                <div class="box box-warning" style="padding:15px">
                    ...
                    {{ Form::open(array('route' => 'contactlist.group.store', 'method' => 'post')) }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ ($errors->has('parent'))? 'has-error' : '' }}">
                                            ...
                                            {{ Form::select('parent',  get_add_contactlist_array(),
                ...
                <div class="panel-body" style=" height: 650px; overflow-y: scroll;">
                    <table class="table table-striped table-responsive">
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::open(['route' => ['contactlist.group.delete', $data->id], 'method' => 'delete']) }}
                                <div class="btn-group btn-group-sm pull-right">
                                    <a href="{{ route('contactlist.group.edit', $data->id)}}" class="btn btn-info" target="_blank">
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::open(['route' => ['contactlist.group.delete', $children->id], 'method' => 'delete']) }}
                                <div class="btn-group btn-group-sm pull-right">
                                    <a href="{{ route('contactlist.group.edit', $children->id)}}" class="btn btn-info" target="_blank">
                                        <i class="voyager-edit" aria-hidden="true"></i>
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::open(['route' => ['contactlist.group.delete', $child->id], 'method' => 'delete']) }}
                                <div class="btn-group btn-group-sm pull-right">
                                    <a href="{{ route('contactlist.group.edit', $child->id)}}" class="btn btn-info" target="_blank">
                                        <i class="voyager-edit" aria-hidden="true"></i>
                                    </a>
