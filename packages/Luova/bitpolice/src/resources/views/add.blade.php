...
<div class="container-fluid">
    <h1 class="page-title">
        <i class="voyager-news"></i> Add Bit Police
    </h1>
        ...
        <div class="col-md-12">
            <div class="panel panel-bordered">
                ...
                <div class="box box-warning" style="padding:15px">
                    ...
                    {{ Form::open(['route' => 'bitpolice.store', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ ($errors->has('bit_name'))? 'has-error' : '' }}">
                                            {{ Form::label('bit_name', 'Bit No.', array('class' => 'bit_name')) }}
                                            {{ Form::text('bit_name', (!empty($fdata->bit_name) ? $fdata->bit_name : NULL), ['class' => 'form-control', 'placeholder' => ' Bit no...']) }}
                                            @if($errors->has('bit_name'))
                                            <span class="help-block">{{ $errors->first('bit_name') }}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ ($errors->has('menu_id'))? 'has-error' : '' }}">
                                            ...
                                            {{ Form::select('menu_id',  get_bitpolice_array(),
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ ($errors->has('location'))? 'has-error' : '' }}">
                                            {{ Form::label('location', ' Location', array('class' => 'location')) }}
                                            {{ Form::text('location', (!empty($fdata->location) ? $fdata->location : NULL), ['class' => 'form-control', 'placeholder' => ' location...']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ ($errors->has('address'))? 'has-error' : '' }}">
                                            ...
                                            {{ Form::textarea('address', (!empty($fdata->address) ? $fdata->address : NULL), ['class' => 'form-control', 'rows' => 2]) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group {{ ($errors->has('map'))? 'has-error' : '' }}">
                                            {{ Form::label('map', ' Google Map Embade ', array('class' => 'map')) }}
                                            {{ Form::textarea('map', (!empty($fdata->map) ? $fdata->map : NULL), ['class' => 'form-control', 'rows' => 2]) }}
                                            @if($errors->has('map'))
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="clphotodelte">
                                            <a href="{{ route('bitpolice.photo.detele', $fdata->id) }}" onclick="return confirm('It will be deleted permanently, Are you sure?')">
