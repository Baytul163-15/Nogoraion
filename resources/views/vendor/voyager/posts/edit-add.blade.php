                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            placeholder="{{ __('voyager::generic.title') }}" required
                ...
                <div class="panel panel panel-bordered panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <select class="form-control hasan" name="category_id">
                            ...
                            <div id="checkboxes">
                                ...
                                <ul class="custom-cat">
                                    ...
                                    <li><label><input type="checkbox" name="post_cat[]" value="{{ $category->id }}"
                                                {{ $categoriesForPost->contains('category_id',$category->id) ? 'checked' : '' }}>
